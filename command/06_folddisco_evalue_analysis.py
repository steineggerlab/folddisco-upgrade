...
EVALUE_FILE = f"total_evalues_fitted_metric{METRIC_NUM}_{METRICS[METRIC_NUM]}14.txt"
...
DATA_DIR = "result_expanded4/folddisco_results_analyses"
RESULT_DIR = "result_expanded4/folddisco_results_evalues14"

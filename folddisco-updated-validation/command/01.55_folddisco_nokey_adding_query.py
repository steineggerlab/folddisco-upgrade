...
# 파일 경로 설정
A_FILE = "result_expanded5/folddisco_results_stats/folddisco_result_summary.txt"
B_FILE = "data/folddisco_info_list_expanded5.txt"
OUT_FILE = "result_expanded5/folddisco_results_stats/folddisco_result_summary_final.txt"

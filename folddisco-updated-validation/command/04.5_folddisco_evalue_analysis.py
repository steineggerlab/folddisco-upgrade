...
DATA_FILE = os.path.join(DATA_DIR, "total_evalues_fitted.txt") 
RESULT_FILE = os.path.join(DATA_DIR, "evalues_stat.txt") 
LOG_FILE = os.path.join(DATA_DIR, "summary_log.txt")
EVAL_CUTOFF = 10

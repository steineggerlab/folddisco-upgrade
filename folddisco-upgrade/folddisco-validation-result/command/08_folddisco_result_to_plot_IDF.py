...
DATA = "result/folddisco_result_2_revisited/total_evalues_fitted.txt"
OUTD = "result/folddisco_result_2_revisited/qc_idf_evalue"
...
qc_path = os.path.join(OUTD, "qc_by_length.tsv")
...
for L in picked:
    ...
    plt.savefig(os.path.join(OUTD, f"ecdf_L{L}.png"), dpi=200)
    plt.close()
    ...
    plt.legend(); plt.tight_layout()
    plt.savefig(os.path.join(OUTD, f"survival_L{L}.png"), dpi=200)
    plt.close()
